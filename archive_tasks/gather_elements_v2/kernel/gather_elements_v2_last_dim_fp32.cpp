...
extern "C" __global__ __aicore__ void gather_elements_v2_last_dim_fp32_custom(
    GM_ADDR x,
    GM_ADDR index,
    GM_ADDR rowMap,
    GM_ADDR y,
...
extern "C" void gather_elements_v2_last_dim_fp32_do(
    ...
    uint8_t *tiling)
{
    gather_elements_v2_last_dim_fp32_custom<<<blockDim, nullptr, stream>>>(x, index, rowMap, y, tiling);
}
#endif
