...
extern "C" __global__ __aicore__ void gather_elements_v2_scalar_fp16_custom(
    GM_ADDR x,
    GM_ADDR index,
    GM_ADDR rowMap,
    GM_ADDR y,
...
extern "C" void gather_elements_v2_scalar_fp16_do(
    ...
    uint8_t *tiling)
{
    gather_elements_v2_scalar_fp16_custom<<<blockDim, nullptr, stream>>>(x, index, rowMap, y, tiling);
}
#endif
